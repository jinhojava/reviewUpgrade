...
import seeandyougo.review.service.RestaurantService;
...
//	private RestaurantService restaurantService;
	...
	public static void main(String[] args) {
		...
		ApplicationContext context = SpringApplication.run(ReviewApplication.class, args);
		...
		restaurant1.setDate("2023-10-15");
		...
		restaurant2.setDate("2023-10-14");
		...
		restaurant3.setDate("2023-10-13");
